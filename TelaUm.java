...
public class TelaUm extends JFrame implements ActionListener, ItemListener {
    ...
    private String nomesTemas[] = { "Duke", "Tux" };
    ...
    public TelaUm() {
        ...
        // texto do rodapé
        desenvolvimento = new JLabel("Desenvolvido em Java", imagemRodape, SwingConstants.CENTER);
    ...
    private void saidaPrograma() {
        ...
        telaSaida.setText(
                ...
                "Jogo da Memoria - 2005nn" + "Desenvolvido por: Luiz Gustavo Stabile de Souzan\n"
                        ...
                        + "Este jogo foi desenvolvido com fins educacionais, portanto sem nenhum tipo de garantia."
